package gl.hud.buttons
{
   ...
   public class LootButton
   {
      ...
      private var lootButtonClass:Class;
      
      private var lootButtonImage:Bitmap;
      
      private var sprite:Sprite;
      
      public function LootButton()
      {
         this.lootButtonClass = LootButton_lootButtonClass;
         this.lootButtonImage = new this.lootButtonClass();
      ...
      {
         this.sprite.addChild(this.lootButtonImage);
